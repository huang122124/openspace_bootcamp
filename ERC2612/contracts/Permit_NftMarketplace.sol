...
contract Permit_NftMarketplace is IERC721Receiver, Ownable {
    ...
    constructor(address nft_addr, address token_addr) Ownable(msg.sender) {
        nft = nft_addr;
    ...
    function buyNFT(
        ...
        require(verify_signature(_user,_salt, _signature));
    ...
    function verify_signature(
        ...
        bytes32  msg_hash = keccak256(abi.encodePacked(_user,_salt));
